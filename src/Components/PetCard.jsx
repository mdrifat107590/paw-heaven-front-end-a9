...
const PetCard = ({ pet }) => {
  const { _id, petName, breed, age, location, image, species, fee } = pet;
  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition duration-300">
      ...
      <div className="p-6">
        ...
        <h2 className="text-3xl font-bold mt-4 mb-3">{petName}</h2>
        ...
        <div className="space-y-2 text-gray-600 mb-5">
          ...
          <p>
            <span className="font-semibold">Adoption Fee:</span> ৳ {fee}
          </p>
        </div>
